...
//go:embed schema/88_magic_equipment_bases.sql
var schemaMagicEquipmentBasesSQL string
...
//go:embed schema/81_ability_dependency_editor.sql
var schemaAbilityDependencyEditorSQL string
