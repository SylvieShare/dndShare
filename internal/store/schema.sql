...
-- ---------------------------------------------------------------------------
-- v3 seed data (charcreate migrations): item types Расы(8)/Классы(9)/Зелья(10),
