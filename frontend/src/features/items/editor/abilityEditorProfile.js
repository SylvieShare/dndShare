...
export const BLOCK_HINTS = {
  ...
  status_effects: 'Эффекты на владельца или другое существо; условие наложения задаётся у связи.',
...
const DEPENDENCY_NAMES = {
  ...
  display_scaling: 'Подпись по уровню', hp_bonuses: 'Бонус хитов', passive_effects: 'Памятка на листе',
...
export function abilityFieldHint(field) {
  ...
  const hints = {
    ...
    class_ids: 'Классы, которым принадлежит способность. Источник уровня для расчётов выбирается отдельно.',
