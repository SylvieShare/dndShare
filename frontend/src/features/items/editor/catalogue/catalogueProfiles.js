...
export const catalogueProfiles = {
  ...
  15: { title: 'Эффект', primary: ['code', 'desc', 'thesis'], groups: [group('effect', 'Применение эффекта', 'polarity color stacking duration concentration'), group('rules', 'Изменения показателей', 'derived_effects', true), group('actions', 'Действия эффекта', 'ongoing_damage weapon_target weapon_damage on_end_effect end_on', true), group('defenses', 'Защиты', 'defenses', true), group('levels', 'Ступени эффекта', 'level max_level', true)] },
