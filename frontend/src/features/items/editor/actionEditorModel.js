...
export function localRuleReferences(data, itemId, itemName) {
  ...
  if (data.initial_charges || data.max_use != null || data.max_use_stat != null || data.max_use_level_multiplier != null || data.max_use_scaling || data.manual_size) add('resource', 'Ресурс способности', data, '')
