...
const morphEditorSources = [
  ...
  '../blocks/dnd/components/DndDiarySessionEditor.vue',
...
describe('MorphEditorShell mobile layout', () => {
  ...
  it('does not autofocus fields when a morph editor opens', () => {
    for (const editorSource of morphEditorSources) {
      expect(editorSource).not.toMatch(/\bautofocus\b/)
    }
  })
})
