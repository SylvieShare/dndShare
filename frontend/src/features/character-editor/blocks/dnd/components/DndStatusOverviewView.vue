...
.dsov-pencil { display: grid; place-items: center; flex-shrink: 0; color: var(--text-muted); opacity: 0.35; transition: color 0.15s, opacity 0.15s; }
@media (hover: hover) { .dsov:hover .dsov-pencil { color: var(--accent); opacity: 1; } }
.dsov-count {
  display: grid;
  place-items: center;
  min-width: 19px;
