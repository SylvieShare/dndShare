<template>
  <button ref="trigger" class="journal-add-event" type="button" :disabled="disabled" :aria-expanded="open" @click="open = !open"><Plus :size="17" /> Добавить событие</button>
  <BasePopover v-model:open="open" :anchor="trigger" placement="bottom-start" :min-width="270" transition-preset="action-menu">
