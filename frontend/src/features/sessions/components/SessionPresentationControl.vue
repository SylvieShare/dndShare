...
.presentation-control { display: contents; }.chapter-tool-btn--presentation { position: relative; display: inline-flex; flex-direction: column; align-items: center; justify-content: center; gap: 5px; min-width: 48px; min-height: 54px; padding: 5px 7px; border: 0; background: transparent;  color: var(--text-muted); cursor: pointer; transition: color .15s; }.chapter-tool-btn--presentation:hover {   color: var(--text-1); }.chapter-tool-btn--presentation.chapter-tool-btn--connected {   color: var(--text-1);  }.presentation-control-dot { position: absolute; top: 5px; right: 5px; width: 5px; height: 5px; border-radius: 50%; background: var(--text-muted); }.presentation-control-dot.connected { background: var(--success); box-shadow: 0 0 7px var(--success); }
