...
const source = readFileSync(fileURLToPath(new URL('./SessionGraphCanvas.vue', import.meta.url)), 'utf8') + readFileSync(fileURLToPath(new URL('../composables/useSessionGraphEdgeActions.js', import.meta.url)), 'utf8')
