...
<style scoped>
.entity-relation-list { display: flex; flex-direction: column; gap: 12px; }.entity-relation-list section { width: 100%; display: grid; grid-template-columns: repeat(auto-fit, minmax(min(100%, 300px), 520px)); justify-content: start; gap: 5px 10px; }.entity-relation-list h3 { grid-column: 1 / -1; display: flex; justify-content: space-between; margin: 0; color: var(--text-muted); font-size: 9px; text-transform: uppercase; letter-spacing: .08em; }.entity-relation-list button { width: 100%; max-width: 520px; display: grid; grid-template-columns: 48px minmax(0,1fr); align-items: center; gap: 10px; padding: 7px; border: 1px solid var(--border); border-radius: 10px; background: color-mix(in srgb,var(--surface-raised) 78%,transparent); color: var(--text-2); cursor: pointer; text-align: left; }.entity-relation-list button:hover { border-color: var(--accent); }.entity-relation-list img,.entity-relation-avatar { width: 48px; height: 48px; display: grid; place-items: center; border-radius: 8px; object-fit: cover; }.entity-relation-avatar { background: color-mix(in srgb,var(--relation-color) 18%,var(--surface)); color: var(--relation-color); font-size: 16px; font-weight: 800; }.entity-relation-list button > span:last-child { min-width: 0; display: flex; flex-direction: column; gap: 2px; }.entity-relation-list strong,.entity-relation-list small { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }.entity-relation-list strong { color: var(--text-1); font-size: 12px; }.entity-relation-list small { color: var(--text-muted); font-size: 10px; }
</style>
