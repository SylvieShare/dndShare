...
<script setup>
import { useSessionGraphEdgeActions } from '../composables/useSessionGraphEdgeActions'
...
const { startLink, finishLink, toggleNestedEdgeDirection, reverseNestedEdge, rewireEdge, openNestedEdgeEdit, requestNestedEdgeDelete } = useSessionGraphEdgeActions({
  sceneGraph, blockGraph, edgeMenus, saving, actionError, displayLevel, emit, beginNestedEdgeEdit, pendingDelete,
  sceneLinkingFrom, blockLinkingFrom, createNestedEdge,
})
