...
export const SESSION_EVENT_CATEGORIES = [
  ...
  { value: 'character', label: 'Персонаж', icon: '✦', types: ['rest_completed', 'spell_used', 'spell_slot_changed', 'feature_action_effect', 'item_spent', 'item_added', 'entry_added', 'resource_used', 'feature_state', 'status_effect'] },
