...
const PERSISTED_KEYS = [
  ...
  'spellIds', 'choices', 'abilitySelections', 'background', 'bgLangIds', 'classEquipmentChoices',
  'backgroundItemChoices', 'backgroundTakeGold', 'backgroundAsi', 'originFeatId', 'originFeatChoices',
