...
@media (hover: hover) {
  ...
  .sbt-main--clickable:hover .sbt-edit { color: var(--accent); background: rgba(255, 255, 255, 0.06); }
}
...
@media (hover: hover) { .sbt-edit:hover { color: var(--accent); background: rgba(255, 255, 255, 0.06); } }
