...
useItemTypesStore(pinia).types = [{ id: 3, name: 'Расовые способности', fields: [{ key: 'desc', name: 'Описание', type: 'description' }] }, { id: 5, name: 'Заклинания', fields: [] }, { id: 7, name: 'Черты', fields: [{ key: 'category', name: 'Категория', type: 'select', filter: true, options: [{ value: 'origin', label: 'Черта происхождения' }, { value: 'general', label: 'Универсальная черта' }] }] }]
