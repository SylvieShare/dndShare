...
На всех мобильных маршрутах, кроме главной, шапка показывает слева общую кнопку
**Назад** вместо бренда. По умолчанию она использует историю router, а экран с
внутренней навигацией может перехватить отменяемое событие
`dndshare:mobile-header-back` и выполнить свой семантический переход.
