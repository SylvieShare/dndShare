...
| Заголовок секции | `shared/ui/SectionLabel.vue` | Компактный общий заголовок. `border` задаёт нижнюю границу локального блока, `divider` продолжает заголовок тихой горизонтальной линией и разделяет крупные смысловые секции внутри одной поверхности. |
