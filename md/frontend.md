...
| Объект сессии на холсте сценария | `features/sessions/components/SceneEntityBlockPreview.vue` | Типизированный live-preview ссылки на локацию, NPC, задание или материал. Каждый тип показывает свои содержательные поля и текущие универсальные связи; данные не дублируются в JSON блока. |
| Универсальные связи сущностей сессии | `features/sessions/components/UniversalRelationEditor.vue`, `UniversalRelationPickerModal.vue`, `UniversalRelationList.vue` | Один типизированный каталог для локаций, NPC, материалов, заданий и сценариев. Picker поддерживает общий поиск и фильтр типа, editor — заметки/удаление, display-list сортирует и группирует по типу. Специализированных редакторов связей со сценариями и главами нет. |
