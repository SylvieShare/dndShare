...
| Объект сессии на холсте сценария | `features/sessions/components/SceneEntityBlockPreview.vue`, `SceneReferenceCreateModal.vue` | Типизированный live-preview ссылки на локацию, NPC, задание или материал. Создание блока начинается с закреплённого по типу picker; новый объект создаётся каноническим предметным редактором. Каждый тип показывает свои содержательные поля, текущие универсальные связи и локальную заметку; название и данные объекта не дублируются в UI-модели блока. |
