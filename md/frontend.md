...
с мобильным меню и задаётся `shared/lib/appNavigation.js`. «Справочник» и
«Правила» являются двумя самостоятельными публичными пунктами без группового
заголовка. Пункт **«Создать персонажа»** остаётся доступен гостю и показывается
сразу под **«Персонажи»** авторизованному пользователю. Над поиском расположен
