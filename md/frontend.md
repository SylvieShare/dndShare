...
| Разделитель секций | `shared/ui/SectionDivider.vue` | Декоративная линия без текста между крупными смысловыми группами внутри одной поверхности. Не ставится перед первой группой и не дублирует собственные заголовки блоков. |
