...
Кубики не являются словарём: поля схемы используют `type:"dice"`, а сохранённый
id равен числу граней (4, 6, 8, 10, 12, 20 или 100). Startup-схема переводит
поля бывшего suggest type 11 на системный тип и удаляет его строки.
