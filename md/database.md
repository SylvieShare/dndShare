...
- `journal_section` задаёт упорядоченный раздел летописи с названием и
  ...
  запись (`battle/dialog/event/newday/quest`), HTML-описание и JSON payload диалога,
  ...
  не меняя существующие записи или каталог заданий сценария. Тип существующей
