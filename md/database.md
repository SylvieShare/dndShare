...
для HTML attribute. `schema/15_rich_content.sql` идемпотентно переводит ровно
согласованный legacy-пример кобольда `1635` (кубики и Внимательность), не
переписывая неизвестные custom tags остальных импортов.
