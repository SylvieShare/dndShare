...
Прибавки расы 2014 и предыстории 2024 используют общий `AbilityBonusPicker`.
Предыстория предлагает режимы +2/+1 и +1/+1/+1 только среди разрешённых
характеристик. Занятые характеристики и исчерпанные варианты недоступны сразу;
повторное нажатие снимает выбор. Смена режима сбрасывает распределение, а
сохранённый черновик восстанавливает соответствующий режим. Этот же компонент
используется при повышении уровня с учётом текущих значений и максимума 20.

Черта происхождения показана стандартной строкой справочника с иконкой,
