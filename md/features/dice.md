...
- `shared/assets/dice/*.svg` — the original d4/d6/d8/d10/d12/d20/d100 artwork recovered from the former `suggest` records and kept as repository-owned source assets. They are archived independently of the current dynamic `SystemDie` renderer.
