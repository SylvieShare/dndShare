...
рамка по типу и отдельная шапка. Иконка стоит слева от названия и повторяется
справа сверху водяным знаком с непрозрачностью 3,5%, не принимающим события мыши.
...
Отдельная вкладка заданий сессии и её shortcut убраны. Каталог `session_quest`
доступен контекстно через ссылки сценария; его данные и связи не удалены.
