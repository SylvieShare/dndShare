...
У мастера рядом с ожидающим статусом есть «Принять передачу»: предмет получает
...
У мастера кнопка называется «Принять применение» и подтверждает расход для
указанного получателя. Принятие не добавляет зелье в его инвентарь; эффекты и
лечение пока отмечаются вручную. Незавершённое применение имеет ту же защиту
