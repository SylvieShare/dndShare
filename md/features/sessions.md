...
или пула ячеек образуют вложенную группу. Порядок событий не меняется;
возвращение к предмету после другого события начинает новую группу.
Ширина поверхности хроники ограничена 980px.
...
Заголовок группы показывает имя персонажа/существа и логин автора (`authorName`),
а у владельца сессии — небольшую метку роли. Увеличенный аватар 52px выводится
без рамки, подложки и тени: character icon с fallback на портрет, media бестиария,
монограмма либо тематический DM fallback. Справа тонкая вертикальная линия
объединяет всю группу; сквозной линии с маркерами слева нет. Время находится
...
через `SpellSlotSphere` в красной рамке «Потрачено» или зелёной «Добавлено»
с количеством; цвет самой ячейки сохраняется. Ручной расход и восстановление
