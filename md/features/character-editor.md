...
тип действия расположен отдельной строкой над таблицей. В начале таблицы
...
Между названием, типом действия и таблицей — отступы 10 px. Длинные названия переносятся
