...
зелёной рамкой и лёгким фоном. При ничьей подсветки победителя нет. «Ещё раз»
...
тип действия расположен отдельной строкой ниже. Между названием и таблицей,
а также перед типом действия — отступ 10 px. Длинные названия переносятся
целиком; формулы при нехватке ширины переходят ниже параметров.
