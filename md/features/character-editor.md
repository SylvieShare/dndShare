...
При открытом собственном листе новые события подключённой сессии и изменения
статуса передач показываются в общей очереди уведомлений вместе с бросками.
Входящая передача предлагает «Открыть события» для принятия или отказа.
